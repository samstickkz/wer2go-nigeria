...
export const metadata: Metadata = {
  ...
  title: {
    default: "wer2 GO Nigeria — Ride-Hailing App | Book a Ride or Drive",
  ...
  keywords: [
    "wer2 GO",
    "ride hailing app Nigeria",
    "book a ride Nigeria",
    "taxi app Nigeria",
    "cab app Nigeria",
    "affordable ride hailing Nigeria",
    "cheap taxi app Nigeria",
    "airport taxi Nigeria",
    "book a ride in Lagos",
    "ride hailing Lagos",
    "taxi app Lagos",
    "book a ride in Abuja",
    "ride hailing Abuja",
    "book a ride in Port Harcourt",
    "ride hailing Port Harcourt",
    "book a ride in Uyo",
    "book a ride in Kano",
    "ride hailing Kano",
    "drive with wer2 GO",
    "ride hailing driver jobs Nigeria",
    "10% driver commission",
    "women only rides Nigeria",
    "Sannu women only rides",
    "safe rides Nigeria",
  ],
